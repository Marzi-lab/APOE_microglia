...
**Supplementary Figure 3a) Differentially expressed genes in the *APOE*-KO vs *APOE3*.**
...
**Supplementary Figure 3b) Differentially expressed genes in the *APOE*-KO vs *APOE3* (excluding *APOE*).**
...
**Supplementary Figure 4a) Heatmap showing differential accessibility of significant peaks (FDR \< 0.05) when comparing APOE4 vs APOE3-expressing microglia. Shown are the genes annotated to the top 20 peaks, genes marked in bold were also significantly differentially expressed in the RNA-seq analysis.**
...
**Supplementary Figure 4b) Heatmap showing differential accessibility of significant peaks (FDR \< 0.05) when comparing the APOE-KO vs APOE3. Shown are the genes annotated to the top 20 peaks, genes marked in bold were also significantly differentially expressed in the RNA-seq analysis.**
...
**Supplementary Figure 5: Stacked barplot of the number of differentially accessible regions (DARs) and how many of these overlap with the DEGs based on peak-to-gene annotation.**
...
**Supplementary Figure 6a) RNA-seq logFC and ATAC-seq logFC correlate across DEGs and their promoter peaks in APOE2 vs APOE3-expressing microglia.**
...
**Supplementary Figure 6b) RNA-seq logFC and ATAC-seq logFC correlate across DEGs and their promoter peaks in *APOE4* vs *APOE2*-expressing microglia.**
...
**Supplementary Figure 6c) RNA-seq logFC and ATAC-seq logFC correlate across DEGs and their promoter peaks in APOE4 vs APOE3-expressing microglia.**
...
**Supplementary Figure 6d) RNA-seq logFC and ATAC-seq logFC correlate across DEGs and their promoter peaks in the *APOE*-KO vs *APOE2*-expressing microglia.**
